...
##############################################################################################################
plotdata.median.tex.vs.lm.e<-function(input.data){
  input.data<-input.data
  input.data$lambda.M.e<-input.data$lambda.M.e/20
#input.data$binned.lambda.M.e <- cut(input.data$lambda.M.e, c(seq(0, 1, 0.1),Inf), labels=seq(0,1,0.1))
  input.data$binned.lambda.M.e <- round(input.data$lambda.M.e, 3)
