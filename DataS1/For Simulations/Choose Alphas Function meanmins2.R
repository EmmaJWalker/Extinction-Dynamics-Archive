...
choose.alphas<-function(nndists.distribution, landscape.limit){
  ...
  a4.min<-nndists.distribution[2]*2 #average dispersal distance = mean(min) nndist x2
  a8.min<-nndists.distribution[2]*4 #average dispersal distance = mean(min) nndist x4
  a16.min<-nndists.distribution[2]*8 #average dispersal distance = mean(min) nndist x8
