...
#GENERATING LANDSCAPE DATA (update these variables as desired)
#############################################################################################################
n.patches=50 #number of habitat patches to be included in the landscape
landscape.limit=100 #extent of the landscape along the x and y axes (ie the space within which patches will be distributed)
no.runs=500 #how many iterations the clustering/declustering algorithm is iterated to make more regular or more clustered landscapes
no.replicates=100 #how many replicates of each landscape type to make
directory="C:/Users/abuga/Desktop/Metapopulation-Simulation-Package-master" #where to save
landscape.types=c("regular", "random", "clustered") #list of all landscape types wanted
#######################################################################################################
